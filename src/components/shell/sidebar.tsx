...
// Brand block: Jadara product mark over the workspace name. Shared by the desktop rail and the
// mobile drawer.
export function BrandBlock({ tenantName }: { tenantName: string }) {
...
// Grouped navigation links. `onNavigate` lets the mobile drawer close itself on a tap.
...
// User chip + theme toggle + sign out. Shared by the rail and the drawer.
export function UserFooter({ userName, email }: { userName: string; email: string }) {
  return (
